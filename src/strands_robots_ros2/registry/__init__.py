...
Usage::
    ...
    from strands_robots_ros2.registry import get_robot, resolve_name, list_robots
    from strands_robots_ros2.registry import get_policy_provider, resolve_policy
